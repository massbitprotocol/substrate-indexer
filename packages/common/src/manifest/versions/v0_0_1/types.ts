import {SubstrateNetworkFilter, ISubstrateRuntimeDatasource} from '@massbit/types';
import {RegisteredTypes} from '@polkadot/types/types';
import {IManifest, INetworkConfig} from '../../types';

export type NetworkConfigV0_0_1 = INetworkConfig & RegisteredTypes;

export interface IRuntimeDataSourceV0_0_1 extends ISubstrateRuntimeDatasource {
  name: string;
