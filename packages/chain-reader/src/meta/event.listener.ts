...
export class MetricEventListener {
  constructor(
    @InjectMetric('indexer_api_connected')
    private apiConnectedMetric: Gauge<string>,
    @InjectMetric('indexer_injected_api_connected')
    private injectedApiConnectedMetric: Gauge<string>,
    @InjectMetric('indexer_block_queue_size')
    private blockQueueSizeMetric: Gauge<string>,
    @InjectMetric('indexer_blocknumber_queue_size')
    private blocknumberQueueSizeMetric: Gauge<string>,
    @InjectMetric('indexer_processing_block_height')
    private processingBlockHeight: Gauge<string>,
    @InjectMetric('indexer_processed_block_height')
    private processedBlockHeight: Gauge<string>,
    @InjectMetric('indexer_target_block_height')
    private targetHeightMetric: Gauge<string>,
    @InjectMetric('indexer_best_block_height')
